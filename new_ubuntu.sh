...
sudo apt-get -y install zsh vim tmux curl glances fcitx fcitx-rime fcitx-config-gtk tig stow ranger i3 i3blocks i3status dmenu cmake arandr dkms fcitx-module-dbus 
